...
def are_two_points_adjacent(first_point: List[int], second_point: List[int]) -> bool:
    ...
    return (
        ...
        # diagonal by 1 unit
        (abs(first_point_col - second_point_col) ==
            1 and abs(first_point_row - second_point_row) == 1)
    )
...
def in_top_left_quarter(first_point: List[int], second_point: List[int]) -> bool:
    ...
    return (
        ...
        (first_point_row == second_point_row -
            2 and first_point_col == second_point_col - 1)
    )
...
def in_top_right_quarter(first_point: List[int], second_point: List[int]) -> bool:
    ...
    return (
        ...
        (first_point_col == second_point_col +
            1 and first_point_row == second_point_row - 2)
    )
...
def in_bottom_left_quarter(first_point: List[int], second_point: List[int]) -> bool:
    ...
    return (
        ...
        (first_point_col == second_point_col -
            2 and first_point_row == second_point_row + 2)
    )
...
for move in moves:
    ...
    execute_move(direction, steps_count, head_pos,
                 tail_pos, all_tail_positions)
