...
used_space = size_lookup['/']
remained_space = TOTAL_DISK_SPACE - used_space

smallest_valid_directory_size_to_delete = used_space
for path in directory_abs_path:
  directory_size = size_lookup[path]
  remained_space_if_delete_the_directory = remained_space + directory_size
  if remained_space_if_delete_the_directory > 30_000_000 and directory_size < smallest_valid_directory_size_to_delete:
    smallest_valid_directory_size_to_delete = directory_size

print('smallest_valid_directory_size_to_delete = ', smallest_valid_directory_size_to_delete)
